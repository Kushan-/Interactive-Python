#http://www.codeskulptor.org/#user46_emdeqOC8qL_0.py
...
#        print self.animated
        if self.animated == True:
            explosn_center = [self.image_center[0] + self.age * self.image_size[0], self.image_center[1]]  
            canvas.draw_image(self.image, explosn_center, self.image_size, self.pos, self.image_size,self.angle)    
        else:
            canvas.draw_image(self.image, self.image_center, self.image_size,
                              self.pos, self.image_size, self.angle)
...
#            print self.lifespan
    ...
    def collide(self, other_object):
        ...
        if dist(self.pos, other_object.pos) <= self.radius + other_object.radius:
            explosn_pos = [self.pos[0] + self.get_radius(), self.pos[1] + self.get_radius()]  
            a_explosion = Sprite(explosn_pos, [0,0], 0, 0, explosion_image, explosion_info, explosion_sound)  
...
label = frame.add_label('Use space bar to fire')
label = frame.add_label('  ')
label_1 = frame.add_label('Navigation key to move the ship.')
